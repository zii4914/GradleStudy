package com.zii.study.gradlestudy.util;
...
import com.zii.study.gradlestudy.App;
  ...
  private static void printDeviceInfo(final String filePath) {
    ...
    try {
      PackageInfo pi =
          App.sContext
              .getPackageManager()
              .getPackageInfo(App.sContext.getPackageName(), 0);
      if (pi != null) {
  ...
  public static class Config {
    private Config() {
      ...
      if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
          && App.sContext.getExternalCacheDir() != null)
        sDefaultDir = App.sContext.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
      else {
        sDefaultDir = App.sContext.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
      }
    }
